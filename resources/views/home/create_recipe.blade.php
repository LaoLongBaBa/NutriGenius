...
{{--                <p><?php echo $chat_data['chatgpt_result_data'] ?></p>--}}
            ...
            <div class="" style="width: 50%;float: right">
                ...
                <p>       {{$chat_data['api_edamam_data']['totalNutrients']['WATER']['label']}}:  {{$chat_data['api_edamam_data']['totalNutrients']['WATER']['quantity']}}  {{$chat_data['api_edamam_data']['totalNutrients']['WATER']['unit']}} </p>
                ...
                <p>       {{$chat_data['api_edamam_data']['totalDaily']['CHOCDF']['label']}}:  {{$chat_data['api_edamam_data']['totalDaily']['CHOCDF']['quantity']}}   {{$chat_data['api_edamam_data']['totalDaily']['CHOCDF']['unit']}} </p>
